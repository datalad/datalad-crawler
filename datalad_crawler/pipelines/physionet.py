...
def pipeline(dataset,
    ...
    def write2metafile(data):
        ...
        data['metadata']['License'] = '''Custom-no-derivatives
  All data available from PhysioNet are free data.
  We are not aware of a de facto standard license for free data analogous to the GPL; your suggestions are welcome.
  You may make and redistribute verbatim copies of data files.
  .
  IMPORTANT: Modified copies of data files may not be distributed except terms mentioned at
  https://physionet.org/copying.shtml '''
    ...
    def extract_html(data):
        ...
        # TODO: make it properly formatted etc
    ...
    return [  # Download all the archives found on the project page
        [
            crawler,
            [  # not correct since does it for sub-directories as well  TODO
                extract_html,
                #printnode,
                write2metafile,
                annex,
