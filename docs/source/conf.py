# -*- coding: utf-8 -*-
#
# datalad_crawler documentation build configuration file, created by
...
project = u'Datalad for crawling web resources and automated data distributions'
copyright = u'2013-2018, DataLad team'
...
htmlhelp_basename = 'datalad_crawlerdoc'
...
latex_documents = [
  (master_doc, 'datalad_crawler.tex', u'datalad_crawler Documentation',
